    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div className="d-flex">
          ...
          {/* <div className="bg-vanila rounded mx-2 " onClick={()=>{props.toggleMode('light')}} style={{height: '30px', width: '30px'}}></div>
          <div className="bg-dark rounded mx-2 " onClick={()=>{props.toggleMode('dark')}} style={{height: '30px', width: '30px'}}></div> */}
        </div>

        {/* <button className="btn btn-success btn-sm mx-4" onClick={props.greenMode}> Green Mode </button> */}
